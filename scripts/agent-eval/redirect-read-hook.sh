...
# onto rustcodegraph_node during implementation, not just for Q&A).
#
# When the agent Reads a SOURCE file, deny it and steer to rustcodegraph_node's
...
# Eval artifact only. The production version is an indexed-aware `rustcodegraph`
